...
STAGING_VERSION = '2026.09.25.1'
STAGING_UI_VERSION = '2026.09.25.1'
...
def build(destination, environment, store_url=''):
    ...
    if environment == 'staging':
        ...
        shutil.copyfile(source/'sales-charityclarity.png', destination/'sales-charityclarity.png')
    ...
    if environment == 'staging':
        install=(source/'connector/index.html').read_text(encoding='utf-8').replace('0.3.6','0.4.2').replace('CharityClarity — Staging NY Connector','CharityClarity — New York Connector')
