...
class ConnectorTests(unittest.TestCase):
    ...
    def test_verification_timeout_closed_browser_and_missing_connector_never_negative(self):
        for reason in ['NY_CONNECTOR_VERIFICATION_REQUIRED','NY_CONNECTOR_TIMEOUT','NY_CONNECTOR_BROWSER_CLOSED','NY_CONNECTOR_UNAVAILABLE','NY_CONNECTOR_BUSY','NY_CONNECTOR_VERIFICATION_NETWORK_ERROR','NY_CONNECTOR_SEARCH_NETWORK_ERROR','NY_CONNECTOR_UPDATE_REQUIRED']:
