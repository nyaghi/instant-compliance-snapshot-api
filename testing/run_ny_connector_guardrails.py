...
class ConnectorTests(unittest.TestCase):
    ...
    def test_connector_version_is_bound_to_the_signed_check(self):
        shipped_version=json.loads((Path(__file__).resolve().parents[1]/'browser-connector/manifest.json').read_text())['version']
        for version in ['0.2.1','0.3.0','0.3.1','0.3.2','0.3.3','0.3.4','0.3.5',shipped_version]:
            ...
            if version in {'0.4.1','0.4.2','0.5.0','0.5.1','0.5.2','0.5.3','0.5.4','0.5.5','0.5.6','0.5.7','0.5.8'}:
