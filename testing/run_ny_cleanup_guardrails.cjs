...
async function run(count,delay,{disconnect=false,failFirst=false}={}){
  ...
  window.top=window;
  const capabilities=['lookup-tab-v1','verification-retry-v1','search-verification-retry-v1','search-schema-errors-v1','nullable-ein-v1','queue-v1','connection-recovery-v1','recovery-causes-v1','cleanup-ack-v1'];
  const chrome={runtime:{lastError:null,sendMessage:async()=>({ok:true,version:'0.3.2',capabilities}),connect:()=>{
